function [S1,S1T,S2,S2T,S3,S3T,S4,S4T,S5,S5T,S6,S6T,f,fT] = BuildMatricesandVectors(GI,weights,omega,gammaBM,H,phase,gammaF,gammaTF,Delta_0)
    ...
    for ind1=1:GI.topology
        ...
        for ind2 = 1:GI.topology
            [S1elem,S1Telem,S2elem,S2Telem,S3elem,S3Telem,S4elem,S4Telem,S5elem,S5Telem,S6elem,S6Telem] = GenerateElementMatrix(GI,weights,Gammainv,omega,H,GammaF,GammaTF,NF,GradPhi,GammaFGrad,GammaTFGrad,gammaS,gammaTS,NS,h,ind1,ind2);
