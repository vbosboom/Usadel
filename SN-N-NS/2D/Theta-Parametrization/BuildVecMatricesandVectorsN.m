...
function [S11,S21,f11,f21,f31,f41,fB11,fB21,S12,S22,f12,f22,f32,f42,fB12,fB22,S1n,S2n,f1n,f2n,fB1n,fB2n, ....
            ...
            JfB1nT1S2,JfB1nC1S2,JfB1nT2S2,JfB1nC2S2,JfB2nT1S2,JfB2nC1S2,JfB2nT2S2,JfB2nC2S2] = BuildVecMatricesandVectorsN(GI,points,weights,points1D,weights1D,gamma_B,gamma,E,ksi,thetas1,chis1,thetas2,chis2,thetan,chin,deltas1,deltas2)
    ...
    for ind1 = 1:GI.topology
        [f11elem,f21elem,f31elem,f41elem] = GenerateVecElementVectorS1N(GI,points,weights,E,ksi,Theta,Chi,Delta,Chigrad1,Chigrad2,ind1);
        for ind2 = 1:GI.topology
            [S11elem,S21elem,JS21Telem,Jf11Telem,Jf11Celem,Jf21Telem,Jf31Telem,Jf31Celem,Jf41Telem,Jf41Celem] = GenerateVecElementMatrixS1N(GI,points,weights,E,ksi,Theta,Chi,Delta,Chigrad1,Chigrad2,ind1,ind2);
    ...
    for ind1 = 1:GI.topology
        [f12elem,f22elem,f32elem,f42elem] = GenerateVecElementVectorS2N(GI,points,weights,E,ksi,Theta,Chi,Delta,Chigrad1,Chigrad2,ind1);
        for ind2 = 1:GI.topology
            [S12elem,S22elem,JS22Telem,Jf12Telem,Jf12Celem,Jf22Telem,Jf32Telem,Jf32Celem,Jf42Telem,Jf42Celem] = GenerateVecElementMatrixS2N(GI,points,weights,E,ksi,Theta,Chi,Delta,Chigrad1,Chigrad2,ind1,ind2);
    ...
    Chi = points*(chin(GI.convn(GI.elmatn))).';
    %gradients
    Chigrad1 = sum(chin(GI.convn(GI.elmatn)).*GI.bn,2);
    Chigrad2 = sum(chin(GI.convn(GI.elmatn)).*GI.cn,2);
    
    for ind1 = 1:GI.topology
        [f1nelem,f2nelem] = GenerateVecElementVectorNN(GI,points,weights,E,Theta,Chi,Chigrad1,Chigrad2,ind1);
        for ind2 = 1:GI.topology
            [S1nelem, S2nelem, JS23Telem,Jf13Telem,Jf13Celem,Jf23Telem] = GenerateVecElementMatrixNN(GI,points,weights,E,Theta,Chi,Chigrad1,Chigrad2,ind1,ind2);
    ...
    for ind1 = 1:GI.topologybnd
        [fB11elem,fB21elem,fB1nelem,fB2nelem] = GenerateVecBoundaryElementVectorSN(points1D,weights1D,gamma_B,gamma,ksi,lek,ThetaS,ChiS,ThetaN,ChiN,ind1);
    ...
    for ind1 = 1:GI.topologybnd
        [fB12elem,fB22elem,fB1nelem,fB2nelem] = GenerateVecBoundaryElementVectorSN(points1D,weights1D,gamma_B,gamma,ksi,lek,ThetaS,ChiS,ThetaN,ChiN,ind1);
        for ind2 = 1:GI.topologybnd
