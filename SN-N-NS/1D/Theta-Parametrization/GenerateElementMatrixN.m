%Compute the matrices and Jacobians obtained in the weak formulation of the
%1D Usadel equation in the theta,chi-parametrization
%S1 corresponds to -(d(theta_N)/dx)^2
%f2 corresponds to -d/dx(sin(theta_N)^2*(d(chi_N)/dx)^2)
